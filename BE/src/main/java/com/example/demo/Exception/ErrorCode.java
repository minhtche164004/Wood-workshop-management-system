...
public enum ErrorCode {
    ...
    COST_DEPOSIT(1043,"Tiền đặt cọc nhỏ hơn giá trị tối thiểu(20% tổng giá trị đơn hàng) , vui lòng nhập lại!",HttpStatus.BAD_REQUEST),
    ...
    COST_REFUND_INVALID(1044,"Số tiền hoàn phải nhỏ hơn tổng giá trị đơn hàng , vui lòng nhập lại!",HttpStatus.BAD_REQUEST),

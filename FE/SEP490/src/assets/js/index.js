...
// Back to top
var backtotop = document.getElementById('your-backtotop-element-id'); // Thay 'your-backtotop-element-id' bằng id thực của phần tử backtotop
...
if (backtotop !== null) {
    ...
    console.error("Không tìm thấy phần tử backtotop trong DOM.");
}

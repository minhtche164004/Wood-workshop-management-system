...
public class ProductErrorAllDTO {
    ...
    public ProductErrorAllDTO(int id, String code, String des, boolean fix, String solution, String job_name, int job_id, int product_id, String product_name, int request_product_id, String request_product_name, String code_order, String user_name_order, String employee_name,String position_name,int position_id,int quantity) {
        this.id = id;
        this.code = code;
        this.des = des;
        this.fix = fix;

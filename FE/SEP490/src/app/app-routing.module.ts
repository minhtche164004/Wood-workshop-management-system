...
const routes: Routes = [
  ...
  { path: 'admin', component: UserManagementComponent, canActivate: [AuthGuard], data: { roles: ['QUẢN TRỊ VIÊN'] } },
  ...
  { path: 'admin_manager_user', component: UserManagementComponent, canActivate: [AuthGuard], data: { roles: ['QUẢN TRỊ VIÊN'] } },
  ...
  { path: 'productsList', component: ProductListComponent, canActivate: [AuthGuard], data: { roles: ['QUẢN LÝ'] } },
  { path: 'product_management', component: ProductManagementComponent, canActivate: [AuthGuard], data: { roles: ['QUẢN LÝ'] } },
  { path: 'product_management/:id', component: ProductManagementComponent, canActivate: [AuthGuard], data: { roles: ['QUẢN LÝ'] } },

  { path: 'order_rq', component: OrderRequiredComponent, canActivate: [AuthGuard] },
  { path: 'supplier_management', component: SupplierManagementComponent, canActivate: [AuthGuard], data: { roles: ['QUẢN LÝ'] } },
  { path: 'profile', component: ViewProfileComponent },
  { path: 'submtr_management', component: SubMaterialManagementComponent, canActivate: [AuthGuard], data: { roles: ['QUẢN LÝ'] } },
  { path: 'create_order', component: CreateOrderComponent},
  { path: 'payment-salary', component: PaymentSalaryComponent },
  { path: 'upload', component: FileUploadComponent },
  { path: 'product_list', component: ProductListComponent },
  { path: 'order_detail_management', component: OrderDetailManagementComponent, canActivate: [AuthGuard], data: { roles: ['QUẢN LÝ'] } },
  { path: 'order_request_management', component: OrderRequestComponentComponent, canActivate: [AuthGuard], data: { roles: ['QUẢN LÝ'] } },
  { path: 'order_request_management/:id', component: OrderRequestComponentComponent, canActivate: [AuthGuard], data: { roles: ['QUẢN LÝ'] } },
  { path: 'orderRq_detail', component: OrderRqDetailComponent, canActivate: [AuthGuard], data: { roles: ['QUẢN LÝ'] } },
  { path: 'contact', component: ContactComponent },
  { path: 'about-us', component: AboutUsComponent },
  { path: 'order_management', component: OrderManagementComponent, canActivate: [AuthGuard], data: { roles: ['QUẢN LÝ'] } },
  { path: 'product-details', component: ProductDetailComponent },
  { path: 'job_management', component: JobManagementComponent, canActivate: [AuthGuard], data: { roles: ['QUẢN LÝ'] } },
  ...
  { path: 'static-report', component: ChartComponent, canActivate: [AuthGuard], data: { roles: ['QUẢN LÝ'] } },
  { path: 'manager', component: ChartComponent, canActivate: [AuthGuard], data: { roles: ['QUẢN LÝ'] } },
  { path: 'material_management', component: MaterialManagementComponent, canActivate: [AuthGuard], data: { roles: ['QUẢN LÝ'] } },
  { path: 'report_management', component: ReportManagementComponent, canActivate: [AuthGuard], data: { roles: ['QUẢN LÝ'] } },
  { path: 'report_management/:id', component: ReportManagementComponent, canActivate: [AuthGuard], data: { roles: ['QUẢN LÝ'] } },
  { path: 'advanced_bill', component: AdvancedBillManagementComponent, canActivate: [AuthGuard], data: { roles: ['QUẢN LÝ'] } },
  { path: 'feedback_defective', component: FeedbackDefectiveComponent, canActivate: [AuthGuard], data: { roles: ['QUẢN LÝ'] } },
  { path: 'total_salary', component: TotalSalaryComponent, canActivate: [AuthGuard], data: { roles: ['QUẢN LÝ'] } },
  { path: 'autoComplete', component: AutoCompleteComponent },
  { path: 'history_order', component: HistoryOrderComponent },
  { path: 'request_product', component: ListRequestProductComponent },

  { path: 'employee', component: ListJobDoneEmployeeComponent, canActivate: [AuthGuard], data: { roles: ['NHÂN VIÊN'] } },
  { path: 'list_job_done', component: ListJobDoneComponent, canActivate: [AuthGuard], data: { roles: ['QUẢN TRỊ VIÊN'] } },
  { path: 'list_request_customer', component: ListRequestCustomerComponent, canActivate: [AuthGuard], data: { roles: ['QUẢN LÝ'] } },
  { path: 'list_salary_employee', component: ListSalaryEmployeeComponent, canActivate: [AuthGuard], data: { roles: ['NHÂN VIÊN'] } },
  ...
  { path: 'im_history', component: ImpactHistoryManagerComponent, canActivate: [AuthGuard], data: { roles: ['QUẢN LÝ'] } },
  { path: '', redirectTo: '/homepage', pathMatch: 'full' },
  { path: '**', redirectTo: '/homepage', pathMatch: 'full' },
